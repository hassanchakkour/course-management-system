...
const CourseSummary = () => {
  ...
  const getActivityData = async () => {
    ...
    const res = await axios.post(
      "http://localhost:5000/api/activities/teacher",
      sendData
    );
  ...
  return (
    <div className="text-white mt-10 flex flex-row">
      <div className="text-4xl  ml-[5%] mt-12 font-bold max-[850px]:ml-5 max-[850px]:text-2xl">
        Course <br />
        Summary
      </div>
      <div className="flex max-[850px]:hidden">
        ...
        <div className="border border-gray-600 h-20 mt-[50px]"></div>
        <div className="pr-24 ml-10">
          <div className="text-5xl ml-10 overline decoration-[#03C9D7] pt-2 mb-5 mt-10 font-bold text-center">
            {assignmentNbr}
          </div>
