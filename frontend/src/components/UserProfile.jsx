    ...
    >
      <div className="mt-1">
        <div className="relative flex">
          ...
          <div className="border z-10 border-white h-8 ml-7 absolute md:left-5 left-3.5 top-2 opacity-30"></div>
          <button
            style={{
              color: "white",
              borderRadius: "6px",
        ...
        <div className="relative">
          ...
          <div className="border z-10 border-white h-8 ml-7 absolute md:left-5 left-3.5 top-4 opacity-50"></div>
          <button
            type="button"
            onClick={() => {
